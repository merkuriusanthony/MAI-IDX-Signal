"""IDX universe sector mapping — 963 symbols, crawled from Yahoo Finance."""
from __future__ import annotations

IDX_SECTORS: dict[str, dict] = {
    "AADI": {
    ...
    "AIMS": {
        "industry": "Thermal Coal",
        "name": "PT Artha Mahiya Investama Tbk",
        "sector": "Energy"
    },
    "AISA": {
    ...
    "BPFI": {
        "industry": "Credit Services",
        "name": "PT Woori Finance Indonesia Tbk",
        "sector": "Financial Services"
    },
    "BPII": {
        "industry": "Asset Management",
    ...
    "CSMI": {
        "industry": "Restaurants",
        "name": "PT Cipta Selera Murni Tbk",
        "sector": "Consumer Cyclical"
    },
    "CSRA": {
        "industry": "Farm Products",
    ...
    "DPUM": {
        "industry": "Packaged Foods",
        "name": "PT Dua Putra Utama Makmur Tbk",
        "sector": "Consumer Defensive"
    },
    "DRMA": {
        "industry": "Auto Parts",
    ...
    "ISAP": {
        "industry": "Metal Fabrication",
        "name": "PT Isra Presisi Indonesia Tbk",
        "sector": "Industrials"
    },
    "ISAT": {
        "industry": "Telecom Services",
    ...
    "KARW": {
        "industry": "Marine Shipping",
        "name": "PT Meratus Jasa Prima Tbk",
        "sector": "Industrials"
    },
    "KAYU": {
        "industry": "",
    ...
    "KREN": {
        "industry": "Asset Management",
        "name": "PT Quantum Clovera Investama Tbk",
        "sector": "Financial Services"
    },
    "KRYA": {
        "industry": "Engineering & Construction",
    ...
    "PDPP": {
        "industry": "Packaging & Containers",
        "name": "PT Primadaya Plastisindo Tbk",
        "sector": "Consumer Cyclical"
    },
    "PEGE": {
        "industry": "Capital Markets",
    ...
    "SGRO": {
        "industry": "Farm Products",
        "name": "PT Prime Agri Resources Tbk",
        "sector": "Consumer Defensive"
    },
    "SHID": {
        "industry": "Lodging",
    ...
    "YOII": {
        "industry": "Insurance - Diversified",
        "name": "PT Asuransi Digital Bersama TBK",
        "sector": "Financial Services"
    },
    "YPAS": {
        "industry": "Packaging & Containers",
...
# Simple label map for sector ranking display
SECTOR_MAP: dict[str, str] = {sym: d['sector'] for sym, d in IDX_SECTORS.items()}
